    ...
    <noscript><link rel="stylesheet" href="assets/css/noscript.css"/></noscript> */}
      ...
      <body class='is-preload'>
        ...
        <section id='banner'>
          ...
          <footer>
            <a href='#first' class='button style2 scrolly'>
              Act on this message
            </a>
          </footer>
        </section>
        ...
        <article id='first' class='container box style1 right'>
          ...
          <div class='inner'>
            ...
            <p>
              Tortor faucibus ullamcorper nec tempus purus sed penatibus.
              Lacinia pellentesque eleifend vitae est elit tristique velit
              tempus etiam.
            </p>
          </div>
        </article>
        ...
        <article class='container box style1 left'>
          ...
          <div class='inner'>
            ...
            <p>
              Rhoncus mattis egestas sed fusce sodales rutrum et etiam
              ullamcorper. Etiam egestas scelerisque ac duis magna lorem ipsum
              dolor.
            </p>
          </div>
        </article>
              ...
              <div class='col-3 col-12-mobile'>
                <a href='images/fulls/04.jpg' class='image fit'>
                  <img
                    ...
                    alt=''
                    title="I'll have a cup of Disneyland, please"
                  />
                </a>
              </div>
            </div>
              ...
              <div class='col-3 col-12-mobile'>
                <a href='images/fulls/07.jpg' class='image fit'>
                  <img
                    ...
                    alt=''
                    title='History was made here'
                  />
                </a>
              </div>
              <div class='col-3 col-12-mobile'>
                <a href='images/fulls/08.jpg' class='image fit'>
                  <img
                    src='images/thumbs/08.jpg'
                    alt=''
                    title='People come and go and walk away'
                  />
                </a>
              </div>
            </div>
    ...
    <!-- */}
        <article class='container box style3'>
          ...
          <section>
            ...
            <p>
              Phasellus nisl nisl, varius id{' '}
              <sup>porttitor sed pellentesque</sup> ac orci. Pellentesque
              habitant <strong>strong</strong> tristique <b>bold</b> et netus{' '}
              <i>italic</i> malesuada <em>emphasized</em> ac turpis egestas.
              Morbi leo suscipit ut. Praesent <sub>id turpis vitae</sub> turpis
          ...
          <section>
            ...
            <p>
              Donec consectetur <a href='#'>vestibulum dolor et pulvinar</a>.
              Etiam vel felis enim, at viverra ligula. Ut porttitor sagittis
              lorem, quis eleifend nisi ornare vel. Praesent nec orci facilisis
              leo magna. Cras sit amet urna eros, id egestas urna. Quisque
              aliquam tempus euismod. Vestibulum ante ipsum primis in faucibus
            ...
            <p>
              ...
              eleifend nisi ornare vel. Praesent nec orci facilisis leo magna.
